...
<div class="block-header">
    <div class="row clearfix">
        ...
        <div class="col-md-6 col-sm-12 text-right">
            <?= "<?php " ?>Modal::begin([
                    'title' => <?= $generator->generateString(Inflector::pluralize(Inflector::camel2words('Create '.StringHelper::basename($generator->modelClass)))) ?>,
                    'centerVertical' => false,
                    'id' => <?= $generator->generateString(Inflector::pluralize(Inflector::camel2words('create'.StringHelper::basename($generator->modelClass)))) ?>,
                    'toggleButton' => [
